...
const serializers = {
    ...
    types: {
        ...
        videoBlock: props => {
            const videoUrl = 'https://cdn.sanity.io/files/' + SANITY_PROJECT_ID + '/production/' + props.node.videoFile.asset._ref
                .replace('file-', '')
                .replace('-mp4', '.mp4')
        ...
        audioBlock: props => {
            const audioUrl = 'https://cdn.sanity.io/files/' + SANITY_PROJECT_ID + '/production/' + props.node.audioFile.asset._ref
                .replace('file-', '')
                .replace('-mp3', '.mp3')
